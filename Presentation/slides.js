...
const SLIDES = [
  ...
  { id:'po-pic', label:'Overview Image' },
  { id:'po1', label:'Project Overview' },
  { id:'ls-pic', label:'Literature Survey' },
  { id:'ls1', label:'Literature Content' },
  { id:'ls2', label:'Literature Continued' },
  { id:'dataset-pic', label:'Dataset Image' },
  { id:'d1', label:'Dataset' },
  { id:'d2', label:'Dataset Continued' },
  { id:'fe-pic', label:'Feature Extraction' },
  { id:'fe1', label:'Feature Extraction' },
  { id:'fe2', label:'EDA Findings' },
  { id:'fe3', label:'Feature Engineering' },
  { id:'ml-pic', label:'Machine Learning' },
  { id:'ml1', label:'ML Models' },
